...
<link rel="stylesheet" type="text/css"
	href="resources/js_css/base.css" media="all">
<link rel="stylesheet" type="text/css"
	href="resources/js_css/plist20131112.css" media="all">
<link rel="stylesheet" type="text/css"
	href="resources/js_css/list-page-20141009.css" media="all">
<link rel="stylesheet" type="text/css"
	href="resources/js_css/pop_compare.css" media="all">
<link rel="shortcut icon" type="image/ico"
	href="http://list.jd.com/favicon.ico">
<script type="text/javascript"
	src="resources/js_css/jquery-1.2.6.pack.js"></script>
...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="http://www.jd.com/" hidefocus="true"><b></b><img src="resources/js_css/logo-201305.png" width="270" height="60" alt="京东"></a></div>
		<!--logo end-->
		<div id="search-2013">
			<div class="i-search ld">
				<ul id="shelper" class="hide"></ul>
				<form id="actionForm" action="product/list" method="POST">
				<div class="form">
					<input type="text" class="text" accesskey="s" name="queryString" id="key" value="${vo.queryString }"
						autocomplete="off" onkeydown="javascript:if(event.keyCode==13) {query()}">
					<input type="button" value="搜索" class="button" onclick="query()">
				</div>
				<input type="hidden" name="catalog_name" id="catalog_name" value="${vo.catalog_name }"/> 
			...
			<div class="lh-wrap">
				<div class="p-img">
					<a target="_blank" href="#">
						<img width="220" height="282" class="err-product" src="resources/images/${item.picture}">
					</a>
				</div>
				<div class="p-name">
...
<div class="w">
    ...
    <div id="footer-2013">
        ...
        <div class="authentication"><a rel="nofollow" target="_blank" href="http://www.hd315.gov.cn/beian/view.asp?bianhao=010202007080200026"><img width="108" height="40" alt="经营性网站备案中心" src="resources/js_css/108_40_zZOKnl.gif" class="err-product"></a>
